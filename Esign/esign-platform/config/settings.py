...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,
    # throttle rates (no global throttle class; applied per-view only)
    'DEFAULT_THROTTLE_RATES': {
        'signing_token': '30/hour',
    },
}
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:3000",  # Create React App's default port
]
CORS_URLS_REGEX = r'^.*$'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@esign.com')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@esign.com')
